...
## docker build -t docker.synapse.org/syn7237116/clin-age-iss-all-sc:version1 .
## docker images
## docker login docker.synapse.org
## docker push docker.synapse.org/syn7237116/clin-age-iss-all-sc:version1

## Only argument is the name of the annotation file for this sub-Challenge (e.g., "sc2_Training_ClinAnnotations.csv"
## for SC2)
...
source(paste0(base.dir, "impute.R"))
source(paste0(base.dir, "utilities.R"))

## Read in the names of the Challenge data files.
chal_data_df <- get.challenge.files()
...
training.validation.file <- paste0(download.dir, anno.file)
