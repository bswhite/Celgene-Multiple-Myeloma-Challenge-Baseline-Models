...
## docker build -t docker.synapse.org/syn7237116/expr-cyto-srf:version2 .
## docker images
## docker login docker.synapse.org
## docker push docker.synapse.org/syn7237116/expr-cyto-srf:version2

## docker build -t docker.synapse.org/syn10155785/expr-cyto-srf:version2 .
## docker images
## docker login docker.synapse.org
## docker push docker.synapse.org/syn10155785/expr-cyto-srf:version2
...
trained.rf <- rfsrc(Surv(D_PFS, D_PFS_FLAG) ~ ., data = data[!is.na(data$D_PFS) & !is.na(data$D_PFS_FLAG),], ntree = 500, tree.err = TRUE)
