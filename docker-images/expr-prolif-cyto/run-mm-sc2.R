...
## "target.gene.entrez"--the list of translocation entrez target genes
## "proliferation.gene.entrez"--the list of entrez proliferation genes
## "ribosomal.gene.entrez"--the list of entrez ribosomal genes
## "target.gene.entrez", the average of "proliferation.gene.entrez", the average of "ribosomal.gene.entrez",
## D_ISS, D_Age, and D_Gender are the features in the model.
...
proliferation.gene.entrez <- model.state[["proliferation.gene.entrez"]]
ribosomal.gene.entrez <- model.state[["ribosomal.gene.entrez"]]
